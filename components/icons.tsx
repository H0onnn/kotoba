...
export const BookmarkFilledIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    aria-hidden='true'
    focusable='false'
    height={size || height}
...
export const BookmarkIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    aria-hidden='true'
    focusable='false'
    height={size || height}
...
export const DeleteIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  ...
  >
    <path
      ...
      fill='currentColor'
    />
    <path d='M10 11v6a1 1 0 002 0v-6a1 1 0 00-2 0zM14 11v6a1 1 0 002 0v-6a1 1 0 00-2 0z' fill='currentColor' />
  </svg>
);
